...
import { PracticeAssignment, MasterQuestion, GlobalSettings } from '../../types';
...
const PupilPracticeHub: React.FC<PupilPracticeHubProps> = ({ schoolId, studentId, studentName, settings, onSettingChange }) => {
  ...
  const { specialMocks, regularPractice } = useMemo(() => ({
    ...
    regularPractice: availableShards.filter(s => s.pushedBy !== 'HQ-SERIALIZED')
  }), [availableShards]);
